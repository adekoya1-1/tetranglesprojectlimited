...
import "../About styles/aboutbanner.css";
      ...
      <div id="about">
        <div id="dynamic">
          ...
          <p>
            ...
            infrastructure and real estate development. With a strong commitment
            to quality and sustainability, our company delivers cutting-edge
          ...
          <div>
            <div id="buildings">
              ...
              <div id="building">
                ...
                <p>
                  Involves planning, designing, and assembling structures using
                  various materials.
                </p>
              </div>
            </div>
            ...
            <div id="buildings">
              ...
              <div id="building">
                <h6>Custom Design</h6>
                <p>
                  Transforming spaces, exterior painting enhances aesthetics and
